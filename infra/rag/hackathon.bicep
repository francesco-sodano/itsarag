...
var realSecrets = (length(oidcClientSecret) > 0)
  ...
  : []
var mockstockDBConnectionString = 'mssql+pyodbc://${sqlServerAdminLogin}:${sqlServerAdminAccess}@${sqlServerName}.database.windows.net/${mockstockDBName}?driver=ODBC+Driver+18+for+SQL+Server'
var secrets = concat(
  [
    {
    ...
    }
    {
      ...
      value: 'mssql+pyodbc://${sqlServerAdminLogin}:${sqlServerAdminAccess}@${sqlServerName}.database.windows.net/${defaultDatabaseName}?driver=ODBC+Driver+18+for+SQL+Server'
    }
    {
